  ...
  return (
    <div>
        ...
        <form onSubmit={(e) => e.preventDefault()} className='w-3/12 absolute p-12 bg-black my-36 mx-auto right-0 left-0 text-white rounded-lg bg-opacity-80'>
          ...
          <input ref={email} type= "text" placeholder='EmailAdress' className='p-2 my-4 w-full bg-gray-700'/>
          <input ref={password} type= "password" placeholder='Passowrd' className='p-2 my-4 w-full bg-gray-700'/>
